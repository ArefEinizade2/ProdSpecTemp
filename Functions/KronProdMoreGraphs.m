function W_prod = KronProdMoreGraphs(W_cell)
%% A function to generate the Kronecker graph product of posssibly more than two factor graph adjacencies:
...
W_prod = KronProdTwoGraphs(W_cell{1}, W_cell{2});

for i = 3 : n
    
    W_prod = KronProdTwoGraphs(W_prod, W_cell{i});
