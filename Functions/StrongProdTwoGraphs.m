function W_prod = StrongProdTwoGraphs(W1, W2)

%% A function to generate the Strong graph product of two factor graph adjacencies:
...
W_prod = kron(W1, eye(N2)) + kron(eye(N1), W2) + kron(W1, W2);
